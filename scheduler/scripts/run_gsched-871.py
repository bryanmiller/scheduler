...
def main(*,
    ...
    programs_list = ['GS-2018B-Q-127', 'GS-2018B-Q-128', 'GS-2018B-Q-224']

    # Create Parameters
    # params = SchedulerParameters(start=Time("2018-08-02 08:00:00", format='iso', scale='utc'),
    params = SchedulerParameters(start=Time("2018-12-11 08:00:00", format='iso', scale='utc'),
    # params = SchedulerParameters(start=Time("2019-01-18 08:00:00", format='iso', scale='utc'),
