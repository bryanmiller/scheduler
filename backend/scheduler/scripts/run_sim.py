...
def main(*,
    ...
    params=SchedulerParameters(start=datetime.fromisoformat("2026-05-26T08:00:00").replace(tzinfo=ZoneInfo("UTC")),
                                end = datetime.fromisoformat("2026-06-08T08:00:00").replace(tzinfo=ZoneInfo("UTC")),
                               sites=ALL_SITES,
                               # sites=[Site.GN],
                               # sites=[Site.GS],
