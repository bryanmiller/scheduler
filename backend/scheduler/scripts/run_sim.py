...
def main(*,
    ...
    # Initialize the sight DB engine (required by the in-process Calculator).
    ...
    params=SchedulerParameters(start=datetime.fromisoformat("2026-05-15T08:00:00").replace(tzinfo=ZoneInfo("UTC")),
                                end = datetime.fromisoformat("2026-06-01T08:00:00").replace(tzinfo=ZoneInfo("UTC")),
